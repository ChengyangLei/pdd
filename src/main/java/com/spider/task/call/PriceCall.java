...
public class PriceCall extends BaseCall {
    ...
    public void notifyFinish() {
        t.update("update "+table+" set state =?,msg='' where buy_url_id=?",new Object[]{GoodsParserTask.DETAIL_STATE,buyUrlId});
    }
    ...
    public static void main(String[] args) {
        PriceCall call = new PriceCall(1553671);
        try {
            call.call();
        } catch (Exception e) {
            e.printStackTrace();
